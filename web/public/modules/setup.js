...
export class SetupController {
  ...
  setupListeners() {
    ...
    // pagehide rather than beforeunload and why a beacon rather than a fetch.
    // Only the controller that STARTED a setup has the flag set, so the two
    // controllers sharing this dialog cannot both fire one.
